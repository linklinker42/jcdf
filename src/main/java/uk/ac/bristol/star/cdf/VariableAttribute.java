...
public class VariableAttribute {
   ...
   */
  public VariableAttribute(final String name, final AttributeEntry[] rEntries,
    final AttributeEntry[] zEntries) {
    name_ = name;
    rEntries_ = rEntries;
    zEntries_ = zEntries;
  }
   ...
   */
  public AttributeEntry getEntry(final Variable variable) {
    final AttributeEntry[] entries = variable.isZVariable() ? zEntries_
      : rEntries_;
    final int ix = variable.getNum();
