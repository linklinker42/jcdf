...
public class CdfDescriptorRecord extends Record {
   ...
   */
  public CdfDescriptorRecord(final RecordPlan plan) throws IOException {
    super(plan, "CDR", 1);
    ...
    final int crLeng = versionAtLeast(2, 5) ? 256 : 1945;
   ...
   */
  private boolean versionAtLeast(final int targetVersion, final int targetRelease) {
