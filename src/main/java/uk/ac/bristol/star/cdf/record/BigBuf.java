...
//import uk.ac.bristol.star.cdf.util.BigByteBuffer;
//
///**
// *
// * @author Christopher J. Weeks
// */
//public class BigBuf implements Buf {
//
//  private final BigByteBuffer byteBuf_;
//  private final BigByteBuffer dataBuf_;
//  private boolean isBit64_;
//  private boolean isBigendian_;
//
//  public BigBuf(ByteBuffer[] byteBuf, boolean isBit64,
//    boolean isBigendian) {
//    byteBuf_ = BigByteBuffer.wrap(byteBuf);
//    dataBuf_ = BigByteBuffer.wrap(duplicate(byteBuf));
//    setBit64(isBit64);
