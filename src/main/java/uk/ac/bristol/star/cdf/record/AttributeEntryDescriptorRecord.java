...
public abstract class AttributeEntryDescriptorRecord extends Record {
   ...
   */
  private AttributeEntryDescriptorRecord(final RecordPlan plan, final String abbrev, final int recordType)
    throws IOException {
  ...
  public static class GrVariant extends AttributeEntryDescriptorRecord {
     ...
     */
    public GrVariant(final RecordPlan plan) throws IOException {
      super(plan, "AgrEDR", 5);
    }
  }
  ...
  public static class ZVariant extends AttributeEntryDescriptorRecord {
     ...
     * @throws java.io.IOException
     */
    public ZVariant(final RecordPlan plan) throws IOException {
      super(plan, "AzEDR", 9);
    }
  }
}
