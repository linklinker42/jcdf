...
public interface Buf {
   ...
   */
  int readUnsignedByte(final Pointer ptr) throws IOException;
   ...
   * @throws java.io.IOException
   */
  int readInt(final Pointer ptr) throws IOException;
   ...
   * @throws java.io.IOException
   */
  long readOffset(final Pointer ptr) throws IOException;
   ...
   * @throws java.io.IOException
   */
  String readAsciiString(final Pointer ptr, final int nbyte) throws IOException;
   ...
   *
   * <p>
   * This method should be called before the <code>readOffset</code>
   * method is invoked.
   *
   * @param isBit64 true for 8-byte offsets, false for 4-byte offsets
   */
  void setBit64(final boolean isBit64);
   ...
   *
   * <p>
   * As currently specified, there are only two possibiliies,
   ...
   *
   * <p>
   * This method should be called before any of the <code>readData*</code>
   * methods are invoked.
   *
   * @param isBigendian true for big-endian, false for little-endian
   */
  void setEncoding(final boolean isBigendian);
   ...
   * @throws java.io.IOException
   */
  void readDataBytes(final long offset, final int count, final byte[] array)
    throws IOException;
   ...
   * @throws java.io.IOException
   */
  void readDataShorts(final long offset, final int count, final short[] array)
    throws IOException;
   ...
   * @throws java.io.IOException
   */
  void readDataInts(final long offset, final int count, final int[] array)
    throws IOException;
   ...
   * @throws java.io.IOException
   */
  void readDataLongs(final long offset, final int count, final long[] array)
    throws IOException;
   ...
   * @throws java.io.IOException
   */
  void readDataFloats(final long offset, final int count, final float[] array)
    throws IOException;
   ...
   * @throws java.io.IOException
   */
  void readDataDoubles(final long offset, final int count, final double[] array)
    throws IOException;
   ...
   * @return input stream
   */
  InputStream createInputStream(final long offset);
   ...
   * @throws java.io.IOException
   */
  Buf fillNewBuf(final long count, final InputStream in) throws IOException;
}
