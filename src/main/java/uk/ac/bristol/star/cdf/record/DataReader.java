...
public class DataReader {
   ...
   */
  public DataReader(final DataType dataType, final int nelPerItem, final int nItem) {
    dataType_ = dataType;
   ...
   */
  public void readValue(final Buf buf, final long offset, final Object valueArray)
    throws IOException {
