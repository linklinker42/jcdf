...
public abstract class Compression {
   ...
   */
  protected Compression(final String name) {
    name_ = name;
  }
   ...
   */
  public abstract InputStream uncompressStream(final InputStream in)
    throws IOException;
   ...
   */
  public static Compression getCompression(final int cType)
